...
function fadeAlert(){
    $('.gradeFilter').fadeTo(500, 0);
    $('.gradeFilter').fadeTo(500, 1);
}

// $('.gradeFilter').fadeTo(500, 1);

// <> Grade Filter alert flickering timing - 3 minutes 1000 - 1 second
setTimeout(() => {
    console.log('called timeout');
    $(".gradeFilter").addClass('d-none');
...
$('.gradeFilter').click(() => {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        ...
        $('[data-bs-target="#o_wevent_index_offcanvas"]').click();
    }
});
