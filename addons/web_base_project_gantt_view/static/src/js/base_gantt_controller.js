...
export class BaseGanttController extends Component {
    setup() {
        ...
        onWillStart(async () => {
            // await loadJS("/web_base_project_gantt_view/static/src/lib/frappe-gantt.js");
            // await loadJS("/web_base_project_gantt_view/static/src/lib/snap.svg-min.js");
            // await loadJS("/web_base_project_gantt_view/static/src/lib/moment.min.js");
            // await loadCSS("/web_base_project_gantt_view/static/src/lib/frappe-gantt.css");
        });
    ...
    onNewTask(){
        ...
        context["default_"+ self.model.metaData.dateStartField] = start_date_formatted;
        if (self.model.metaData.dateStopField) {
            context["default_"+ self.model.metaData.dateStopField] = end_date_formatted;
        } 
    ...
    onClicktimeFrame(ev){
        ...
        var timeFrame = $target.data('timeframe')
